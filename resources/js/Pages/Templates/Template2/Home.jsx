            ...
            <header className="fixed w-full z-10">
                <nav className="bg-white dark:bg-gray-800 shadow-lg">
                    <div className="flex items-center justify-between max-w-screen-xl px-6 py-4 mx-auto">
                        ...
                        {/* Desktop Menu */}
                        <div
                            className={`hidden lg:flex items-center space-x-3 text-lg text-black dark:text-white ${
                                isMenuOpen ? "hidden" : ""
                            }`}
                        >
                            <a
                            ...
                            <button
                                type="button"
                                className="ml-6 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 text-lg rounded-lg px-5 py-2.5 transition duration-200"
                            >
                                Нэвтрэх
                            </button>
                        </div>
