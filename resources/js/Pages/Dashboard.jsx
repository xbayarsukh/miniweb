...
export default function Dashboard({ users, orders1,orders2,orders3,orders4,orders5,ordersToday,orders, newUser,posts}) {
    ...
    useLayoutEffect(() => {
      ...
      image.src = '/assets/img/team-4.jpg'; // Image path in public folder
      ...
      // Handle potential CORS issues by ensuring the image is loaded from the same origin
        ...
        <AuthenticatedLayout>
            ...
            <div className="w-full px-6 py-6 mx-auto">
                ...
                <div className="flex flex-wrap my-6 -mx-3">
                    <div className="w-full max-w-full px-3 mt-0 mb-6 md:mb-0 lg:flex-none">
