                ...
                <div className="xl:bg-gray-800 xl:bg-opacity-50 xl:p-8 xl:col-start-2 xl:grid-cols-10 lg:my-6 md:mx-6 sm:p-6 shadow-md focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 p-8 bg-white bg-opacity-100 rounded-lg">
                    ...
                    <div className="w-full mt-4">
                        <div className="flex flex-col items-start w-64">
                            ...
                            <p>Themesberg Inc., LOUISVILLE, Selby 3864 Johnson Street, United States of America VAT Code: AA-1234567890</p>
                        </div>
                    </div>
                    <div className="w-full mt-4">
                        <table className="w-full">
                            <thead>
                                <tr>
                                    <td className="bg-gray-200 p-3 rounded-l-xl">Item</td>
                                    <td className="bg-gray-200 p-3">Price</td>
                                    <td className="bg-gray-200 p-3">Qty</td>
                                    <td className="bg-gray-200 p-3 rounded-r-xl">Total</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td className="p-3">
                                        <p className="font-bold">ASDFASDFASDFADSF</p>
                                        <p>adsfasdfasdfs</p>
                                    </td>
                                    <td className="p-3">
                                        128,000.00₮
                    ...
                    <div className="flex w-full items-end justify-end mt-4">
                        <table className="w-72">
                            <tr>
                                ...
                                <td className="p-2 text-right">128,000.00₮</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="p-2 text-right font-bold">128,000.00₮</td>
                            </tr>
                        </table>
                    </div>
                </div>
